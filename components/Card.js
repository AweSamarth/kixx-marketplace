...
const Card = ({props}) => {
  return (
    ...
    <div className="w-full max-w-sm bg-transparent rounded-lg  dark:bg-gray-800 dark:border-gray-500 p-8 align-text-bottom">
        <Link href={`/resell/${props._id}`}>
            <div className='px-8 h-max-12'>
            <img className=" p-8 rounded-t-lg bg-transparent transitions-theme rotate-0 hover:rotate-[25deg]" src={props.image} alt="product image" />
            </div>
        </Link>
        <div className="px-7 pb-7 align-bottom">
