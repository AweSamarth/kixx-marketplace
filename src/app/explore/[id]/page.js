        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row -mx-4 justify-center it">
            <div className="md:flex-1 px-4">
              ...
              <div className="flex -mx-2 mb-4 items-center justify-center"></div>
            </div>
            <div className="md:flex-1 px-4">
              <h2 className="text-2xl font-bold text-gray-300 dark:text-white mb-2">
                Product Name
              </h2>
              ...
              <div className="mb-4">
                <span className="font-bold text-gray-300 dark:text-gray-400 mr-2">
                  Select Size:
                </span>
                <select
                  className=" h-9 p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div className="flex -mx-2 mb-4 items-center justify-center">
                <div className="w-1/2 px-2">
                  <button className="w-full bg-slate-200 mt-6 dark:bg-gray-600 text-tertiary py-2 px-4 rounded-full font-bold hover:bg-gray-400 dark:hover:bg-gray-700">
                    Checkout
                  </button>
                </div>
              </div>
